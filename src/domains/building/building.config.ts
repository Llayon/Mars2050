...
export const BUILDING_TYPES: Record<BuildingTypeKey, BuildingType> = {
  ...
  research_lab: { name: 'Исследовательская лаборатория', cost: { minerals: 200, energy: 80 }, production: { research_points: 5 }, consumption: { energy: 15, water: 2 }, description: 'Проводит научные исследования', width: 1, height: 1, workforce: { tier: 'scientist', count: 1 }, unlockedByTier: 'technician' },
  ...
  data_center: { name: 'Дата-центр', cost: { minerals: 300, rare_metals: 10, consumer_goods: 20 }, production: { databanks: 4 }, consumption: { energy: 25 }, description: 'Обрабатывает данные', width: 1, height: 1, workforce: { tier: 'technician', count: 2 }, unlockedByTier: 'technician' },
  ...
  university: { name: 'Университет', cost: { minerals: 800, energy: 400, databanks: 20 }, production: {}, consumption: { energy: 40 }, description: 'Обучение техников', width: 3, height: 2, workforce: { tier: 'technician', count: 3 }, unlockedByTier: 'technician' },
