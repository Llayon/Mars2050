...
export const BUILDING_TYPES: Record<BuildingTypeKey, BuildingType> = {
  solar_panels: { name: 'Солнечные панели', cost: { minerals: 80, energy: 20 }, production: { energy: 15 }, consumption: {}, description: 'Генерирует энергию из солнечного света', width: 1, height: 1 },
  oxygen_generator: { name: 'Кислородный генератор', cost: { minerals: 100, energy: 50 }, production: { oxygen: 10 }, consumption: { energy: 5 }, description: 'Производит кислород для колонии', width: 1, height: 1, staffing: { tier: 'worker', slots: 2, minActiveSlots: 1 } },
  water_extractor: { name: 'Водяной насос', cost: { minerals: 120, energy: 60 }, production: { water: 8 }, consumption: { energy: 8 }, description: 'Добывает воду из марсианских льдов', width: 1, height: 1, staffing: { tier: 'worker', slots: 2, minActiveSlots: 1 } },
  mine: { name: 'Шахта', cost: { minerals: 150, energy: 40 }, production: { minerals: 12 }, consumption: { energy: 10 }, description: 'Добывает полезные ископаемые', width: 1, height: 1, staffing: { tier: 'worker', slots: 2, minActiveSlots: 1 } },
  greenhouse: { name: 'Теплица', cost: { minerals: 100, water: 30 }, production: { food: 6 }, consumption: { water: 4, energy: 3 }, description: 'Выращивает еду для колонистов', width: 1, height: 1, staffing: { tier: 'worker', slots: 2, minActiveSlots: 1 } },
  ...
  vehicle_bay: { name: 'Сборочный цех', cost: { minerals: 500, energy: 200 }, production: {}, consumption: { energy: 20 }, description: 'Производит технику', width: 2, height: 2, staffing: { tier: 'technician', slots: 2, minActiveSlots: 1 }, unlockedByTier: 'technician' },
  habitat_mk2: { name: 'Улучшенный жилой модуль', cost: { minerals: 300, energy: 50, water: 40 }, production: {}, consumption: {}, description: 'Жилье для техников', width: 1, height: 1, unlockedByTier: 'technician' },
  biotech_lab: { name: 'Биотех-лаборатория', cost: { minerals: 400, rare_metals: 10 }, production: { research_points: 10 }, consumption: { energy: 30, water: 10 }, description: 'Продвинутые исследования', width: 2, height: 2, staffing: { tier: 'scientist', slots: 2, minActiveSlots: 1 }, unlockedByTier: 'scientist' },
  data_center: { name: 'Дата-центр', cost: { minerals: 300, rare_metals: 10, consumer_goods: 20 }, production: { databanks: 4 }, consumption: { energy: 25 }, description: 'Обрабатывает данные', width: 1, height: 1, staffing: { tier: 'scientist', slots: 2, minActiveSlots: 1 }, unlockedByTier: 'technician' },
  nanoforge: { name: 'Нанокузница', cost: { minerals: 500, rare_metals: 20, databanks: 10 }, production: { nanomaterials: 2 }, consumption: { rare_metals: 1, energy: 30 }, description: 'Производит наноматериалы', width: 2, height: 2, staffing: { tier: 'scientist', slots: 2, minActiveSlots: 2 }, unlockedByTier: 'scientist' },
  university: { name: 'Университет', cost: { minerals: 800, energy: 400, databanks: 20 }, production: {}, consumption: { energy: 40 }, description: 'Обучение техников', width: 3, height: 2, staffing: { tier: 'scientist', slots: 2, minActiveSlots: 2 }, unlockedByTier: 'technician' },
  habitat_mk3: { name: 'Жилой комплекс', cost: { minerals: 600, energy: 100, water: 80, consumer_goods: 20 }, production: {}, consumption: {}, description: 'Жилье для учёных', width: 2, height: 2, unlockedByTier: 'scientist' },
