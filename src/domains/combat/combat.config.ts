...
export const UNIT_TYPES: Record<UnitTypeKey, UnitTypeConfig> = {
  ...
  // === Aliens ===
  alien_bug: { name: 'Марсианский жук', hireCost: {}, squadSize: 10, squadSpacing: 25, formation: 'grid', baseStats: { hp: 20, attack: 5, defense: 0, speed: 10, range: 0.5, attackType: 'single', actionCooldownMax: 10, turnSpeed: 8, size: 'S' } },
  alien_spitter: { name: 'Кислотный плевун', hireCost: {}, squadSize: 3, squadSpacing: 40, formation: 'line', baseStats: { hp: 40, attack: 20, defense: 2, speed: 6, range: 4, attackType: 'aoe', aoeRadius: 1.5, actionCooldownMax: 12, turnSpeed: 6, size: 'M' } },
  ...
  // === Tier 1 ===
  marine: { name: 'Морпех', hireCost: { minerals: 100, energy: 0 }, squadSize: 8, squadSpacing: 22, formation: 'line', baseStats: { hp: 35, attack: 10, defense: 2, speed: 7, range: 3, attackType: 'single', actionCooldownMax: 8, canTargetAir: true, turnSpeed: 30, size: 'S' } },
  shock_trooper: { name: 'Штурмовик', hireCost: { minerals: 100, energy: 0 }, squadSize: 8, squadSpacing: 22, formation: 'grid', baseStats: { hp: 45, attack: 14, defense: 3, speed: 10, range: 0.5, attackType: 'single', actionCooldownMax: 7, canTargetAir: false, turnSpeed: 40, size: 'S' } },
  ...
  sniper: { name: 'Снайпер', hireCost: { minerals: 100, energy: 50 }, squadSize: 2, squadSpacing: 25, formation: 'wedge', baseStats: { hp: 30, attack: 60, defense: 1, speed: 5, range: 7, attackType: 'single', actionCooldownMax: 30, canTargetAir: true, targetingProfile: 'global', turnSpeed: 15, size: 'S' } },
  scavenger_buggy: { name: 'Багги-стервятник', hireCost: { minerals: 150, energy: 50 }, squadSize: 3, squadSpacing: 40, baseStats: { hp: 80, attack: 15, defense: 4, speed: 14, range: 2, attackType: 'single', actionCooldownMax: 10, turnSpeed: 10, size: 'M' } },
  ...
  heavy_gunner: { name: 'Пулеметчик', hireCost: { minerals: 150, energy: 0 }, squadSize: 6, squadSpacing: 22, formation: 'line', baseStats: { hp: 50, attack: 4, defense: 4, speed: 5, range: 5, attackType: 'single', actionCooldownMax: 2, canTargetAir: true, turnSpeed: 15, size: 'S' } },
  sapper: { name: 'Сапер', hireCost: { minerals: 80, energy: 50 }, squadSize: 3, squadSpacing: 25, formation: 'grid', baseStats: { hp: 30, attack: 150, defense: 1, speed: 9, range: 1, attackType: 'aoe', aoeRadius: 2, actionCooldownMax: 40, turnSpeed: 30, size: 'S' } },
  ...
  // === Tier 2 ===
  exosuit: { name: 'Экзоскелет', hireCost: { minerals: 200, energy: 100 }, squadSize: 4, squadSpacing: 40, baseStats: { hp: 150, attack: 20, defense: 8, speed: 5, range: 1, attackType: 'single', actionCooldownMax: 15, canTargetAir: false, turnSpeed: 10, size: 'M' } },
  gatling_rover: { name: 'Пулеметный Ровер', hireCost: { minerals: 150, energy: 150 }, squadSize: 2, squadSpacing: 40, baseStats: { hp: 120, attack: 8, defense: 5, speed: 7, range: 4, attackType: 'single', actionCooldownMax: 2, canTargetAir: true, turnSpeed: 10, size: 'M' } },
  plasma_tank: { name: 'Плазмо-танк', hireCost: { minerals: 250, energy: 150 }, squadSize: 2, squadSpacing: 40, baseStats: { hp: 200, attack: 40, defense: 10, speed: 6, range: 5, attackType: 'single', actionCooldownMax: 20, turnSpeed: 8, size: 'M' } },
  missile_buggy: { name: 'Ракетный багги', hireCost: { minerals: 200, energy: 200 }, squadSize: 3, squadSpacing: 40, baseStats: { hp: 100, attack: 25, defense: 4, speed: 9, range: 6, attackType: 'single', actionCooldownMax: 15, canTargetAir: true, turnSpeed: 10, size: 'M' } },
  ...
  minelayer_rover: { name: 'Минный укладчик', hireCost: { minerals: 150, energy: 150 }, squadSize: 2, squadSpacing: 40, baseStats: { hp: 130, attack: 15, defense: 6, speed: 8, range: 3, attackType: 'single', actionCooldownMax: 12, turnSpeed: 12, size: 'M' } },

  // === Tier 3 ===
  siege_tank: { name: 'Осадный танк', hireCost: { minerals: 400, energy: 300 }, squadSize: 1, baseStats: { hp: 300, attack: 80, defense: 12, speed: 4, range: 8, attackType: 'aoe', aoeRadius: 2.5, actionCooldownMax: 35, targetingProfile: 'global', turnSpeed: 5, size: 'L' } },
  railgun_walker: { name: 'Рейлган-шагоход', hireCost: { minerals: 450, energy: 400 }, squadSize: 1, baseStats: { hp: 250, attack: 120, defense: 8, speed: 5, range: 7, attackType: 'single', actionCooldownMax: 40, targetingProfile: 'global', turnSpeed: 5, size: 'L' } },
  ...
  artillery_crawler: { name: 'Мобильная артиллерия', hireCost: { minerals: 500, energy: 500 }, squadSize: 1, baseStats: { hp: 250, attack: 500, defense: 8, speed: 3, range: 10, attackType: 'aoe', aoeRadius: 4, actionCooldownMax: 200, targetingProfile: 'global', turnSpeed: 2, size: 'L' } },
