...
export const TIER1_BALANCE_SCENARIOS: CombatBalanceScenario[] = [
  ...
  scenario('tier1_light_walker_anchors_aoe', 'Tier 1: light walker anchors against area damage',
    squads('t1-walker-aoe-a', 'attacker', 'light_walker', 3, 180, 900, 120),
    squads('t1-walker-grenadier-d', 'defender', 'grenadier', 3, 180, 300, 120)),
  scenario('tier1_light_walker_overwhelmed_by_line', 'Tier 1: line infantry overwhelms light walkers',
    squads('t1-walker-line-a', 'attacker', 'light_walker', 3, 180, 900, 120),
    squads('t1-walker-marine-d', 'defender', 'marine', 3, 180, 300, 120)),
  ...
  scenario('tier1_explosive_drone_vs_walker', 'Tier 1: explosive drones breach light walkers',
    squads('t1-drone-walker-a', 'attacker', 'explosive_drone', 3, 180, 900, 120),
    squads('t1-drone-walker-d', 'defender', 'light_walker', 3, 180, 300, 120)),
  scenario('tier1_explosive_drone_screened_out', 'Tier 1: heavy gunners screen explosive drones',
    squads('t1-drone-screen-a', 'attacker', 'explosive_drone', 3, 180, 900, 120),
    squads('t1-drone-heavy-d', 'defender', 'heavy_gunner', 3, 180, 300, 120)),
