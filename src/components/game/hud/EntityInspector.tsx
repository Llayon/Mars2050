...
export const EntityInspector = memo(function EntityInspector({ building, onClose, onDemolish, isMobile }: EntityInspectorProps) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className={`text-[10px] font-bold uppercase tracking-wider flex items-center gap-1 ${building.is_active ? 'text-green-400' : 'text-red-400'}`}>
                    <span className={`w-1.5 h-1.5 rounded-full ${building.is_active ? 'bg-green-400 animate-pulse' : 'bg-red-400'}`}></span>
                    {building.is_active ? 'Активно' : 'Остановлено'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="bg-black/40 rounded-lg p-2 border border-gray-800/50">
                ...
                <div className="text-xs font-mono text-cyan-300">
                  <span className="text-white">?</span> / {config.workforce.count}
                </div>
              </div>
            </div>
