...
export const UNIT_VISUALS: Partial<Record<UnitTypeKey, UnitVisualConfig>> = {
  ...
  missile_buggy: { scale: 1.0, muzzleOffset: 25, fxType: 'fx_impact_orange', vfxScale: 0.8 },
  gunship: { scale: 1.1, yOffset: -30, hoverAmplitude: 4, hoverSpeed: 0.05, muzzleOffset: 40, fxType: 'fx_muzzle_orange', vfxScale: 1.2 },
  engineer: { scale: 1.4 },
  ...
  siege_tank: { scale: 1.2, muzzleOffset: 55, fxType: 'fx_muzzle_orange', vfxScale: 1.5 },
  
  railgun_walker: { scale: 1.15, anchor: { x: 0.5, y: 0.7 }, muzzleOffset: 40, fxType: 'fx_muzzle_cyan', vfxScale: 1.3 },
