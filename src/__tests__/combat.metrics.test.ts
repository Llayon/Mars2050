...
describe('combat movement metrics', () => {
  ...
  it('collects combat metrics when tracking is enabled', () => {
    ...
    expect(result.metrics?.overlapSamples).toBeGreaterThan(0)
    ...
    expect(result.metrics?.averageOverlapRatio).toBeGreaterThanOrEqual(0)
    expect(result.metrics?.maxOverlapRatio).toBeGreaterThanOrEqual(result.metrics?.averageOverlapRatio ?? 0)
    expect(result.metrics?.maxOverlapRatio).toBeLessThanOrEqual(1)
    expect(result.metrics?.severeOverlapSamples).toBeGreaterThanOrEqual(0)
    expect(result.metrics?.severeOverlapSamples).toBeLessThanOrEqual(result.metrics?.overlapSamples ?? 0)
    expect(result.metrics?.averageTimeToEngage).not.toBeNull()
    expect(result.metrics?.averageEngagementDistance).not.toBeNull()
    expect(result.metrics?.meleeSlotWaitTicks).toBeGreaterThanOrEqual(0)
    expect(result.metrics?.damageByUnitType.shock_trooper).toBeGreaterThan(0)
    expect(result.metrics?.damageTakenByUnitType.alien_bug).toBeGreaterThan(0)
    expect(result.metrics?.stuckTicksByUnitType).toBeDefined()
    expect(result.metrics?.targetSwitchesByUnitType).toBeDefined()
    expect(result.metrics?.healingDoneByUnitType).toBeDefined()
