...
test('simulator2 replay fits and renders on a mobile viewport', async ({ page }) => {
  ...
  expect(controlsBox!.height, 'mobile replay controls height').toBeLessThan(130)
  expect(controlsBox!.y + controlsBox!.height, 'mobile replay controls bottom edge').toBeLessThanOrEqual(viewport!.height)
