...
| **26. Tier 1 Visual Coverage** | Пресет "QA: визуалы T1" | Marine, shock trooper, flamethrower, grenadier, heavy gunner, explosive drone, light walker читаются как разные юниты. | Нет fallback-labels вместо спрайтов; временные direct assets дрона и шагохода разрешены до нового арт-прохода. |
