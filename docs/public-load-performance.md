...
- The deterministic combat engine imports only when the player starts a
  simulation and runs in a dedicated Web Worker, keeping the simulator shell
  responsive during large presets.
